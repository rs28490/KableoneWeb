...
public class ActionClass extends BaseClass {
	...
	public static void click(AndroidDriver driver, WebElement ele) {

		Actions act = new Actions(driver);
		act.moveToElement(ele).click().build().perform();

	}
	public static boolean findElement(AndroidDriver driver, WebElement ele) {
		boolean flag = false;
		try {
			ele.isDisplayed();
			flag = true;
	...
	public static boolean isSelected(AndroidDriver driver, WebElement ele) {
		boolean flag = false;
		flag = findElement(driver, ele);
		if (flag) {
			flag = ele.isSelected();
	...
	public static boolean isEnabled(AndroidDriver driver, WebElement ele) {
		boolean flag = false;
		flag = findElement(driver, ele);
		if (flag) {
			flag = ele.isEnabled();
	...
	}public static boolean JSClick(AndroidDriver driver, WebElement ele) {
		boolean flag = false;
		try {
	...
	public static boolean switchToFrameById(AndroidDriver driver,String idValue) {
		boolean flag = false;
		try {
